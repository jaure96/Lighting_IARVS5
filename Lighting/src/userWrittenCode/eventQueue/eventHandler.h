...
/* Include the file that defines EVENT_UNDEFINED and the types VS_UINT8,
   VS_UINT16, VS_UINT32 and SEM_EVENT_TYPE.

   Include <API prefix>SEMLibB.h if you are using the Basic API.
   Include SEMLibE.h if you are using the Expert API. */
